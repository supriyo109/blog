  ...
  const editor = useRef(null);
   ...
   const [blogData, setBlogData] = useState({
    ...
    const updateBlogHandler = async () => {
        ...
        try {
            setLoading(true)
            const res = await axios.put(`https://blog-blox.onrender.com/api/v1/blog/${id}`, formData, {
                headers: {
     ...
     const togglePublishUnpublish = async () => {
        ...
        try {
            const res = await axios.patch(`https://blog-blox.onrender.com/api/v1/blog/${id}`, {
                // params: {
                //     action
                // },
                withCredentials: true
        ...
        try {
            const res = await axios.delete(`https://blog-blox.onrender.com/api/v1/blog/delete/${id}`, { withCredentials: true })
            if (res.data.success) {

  ...
  const editor = useRef(null);
   ...
   const [blogData, setBlogData] = useState({
    ...
    const updateBlogHandler = async () => {
        ...
        try {
            setLoading(true)
            const res = await axios.put(`https://blog-4-uaoh.onrender.com/api/v1/blog/${id}`, formData, {
                headers: {
     ...
     const togglePublishUnpublish = async () => {
        ...
        try {
            const res = await axios.patch(`https://blog-4-uaoh.onrender.com/api/v1/blog/${id}`, {
                // params: {
                //     action
                // },
                withCredentials: true
        ...
        try {
            const res = await axios.delete(`https://blog-4-uaoh.onrender.com/api/v1/blog/delete/${id}`, { withCredentials: true })
            if (res.data.success) {
    ...
    <div className='pb-10 px-3 pt-20 md:ml-[320px]'>
            <div className='max-w-6xl mx-auto mt-8'>
                <Card className="w-full bg-white dark:bg-gray-800 p-5 space-y-2">
                    ...
                    <div className='pt-10'>
                        <Label className='ml-2 mb-2' htmlFor='title'>Title</Label>
                        <Input type="text" placeholder="Enter a title" id='title' name="title" value={blogData.title} onChange={handleChange} className="dark:border-gray-300" />
                    </div>
                    <div>
                        <Label className='ml-2 mb-2' htmlFor='subtitle'>Subtitle</Label>
                        <Input type="text" placeholder="Enter a subtitle" id='subtitle' name="subtitle" value={blogData.subtitle|| ""} onChange={handleChange} className="dark:border-gray-300" />
                    </div>
                    <div>
                        <Label className='ml-2 mb-2'>Description</Label>
                        <JoditEditor
                            ref={editor}
                    ...
                    <div>
                        <Label className='ml-2 mb-2'>Category</Label>
                    ...
                    <div>
                        <Label className='ml-2 mb-2' htmlFor='file'>Thumbnail</Label>
                        <Input
                            id="file"
                            type="file"
